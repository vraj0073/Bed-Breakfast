      ...
      <Grid container component="main" sx={{ height: "100vh" }}>
        ...
        <Grid item xs={12} sm={8} md={6} component={Paper} elevation={6} square>
          ...
          <Box xs={12} sm={12} md={12}>
            <Box>
              <Typography variant="h4">Recommended Package - Nature</Typography>
            ...
            <Box>
              ...
              <Typography variant="h4">4 Days 5 Night </Typography>
            </Box>
            <br />
            <br />
            <Box sx={{ order: 1 }}>
              <Typography variant="body2">Place</Typography>
              <Typography variant="h4">Place - Banff </Typography>
            </Box>
            <br />
            <br />
            <Box>
