      ...
      <Grid container component="main" sx={{ height: "100vh" }}>
        ...
        <Grid item xs={12} sm={8} md={6} component={Paper} elevation={6} square>
          ...
          <Box xs={12} sm={12} md={12}>
            <Box>
              <Typography variant="h4">Recommended Package - Adventure</Typography>
            ...
            <Box>
              ...
              <Typography variant="h4">6 Days 7 Night </Typography>
            </Box>
            <br />
            <br />
            <Box sx={{ order: 1 }}>
              <Typography variant="body2">Place</Typography>
              <Typography variant="h4">Place - Shobbie Park </Typography>
            </Box>
            <br />
            <br />
            <Box>
